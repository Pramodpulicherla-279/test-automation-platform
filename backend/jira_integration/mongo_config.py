...
Usage:
    from jira_integration.mongo_config import mongo_config, connect_mongodb, disconnect_mongodb, get_tickets_collection, is_mongodb_enabled
"""
...
# ─────────────────────────────────────────────────────────────────────────────
# Robust .env loading — tries multiple locations
# ─────────────────────────────────────────────────────────────────────────────
def _load_env() -> None:
    """
    ...
    _proj_root  = os.path.dirname(_backend)

    candidates = [
        os.path.join(_backend,   ".env"),
        os.path.join(_proj_root, "backend", ".env"),
        os.path.join(_proj_root, ".env"),
