...
import UIScreenshotIssues from './components/UIScreenshotIssues';
    ...
    <div className="app-container">
      <header className="app-header">
        ...
        <div className='status-cont'>
          ...
          <button
            onClick={() => setShowUiIssuesScreen((prev) => !prev)}
            disabled={uiAnalysisStatus === 'loading'}
            ...
            title={showUiIssuesScreen ? "Close UI Screenshot Issues screen" : "Open UI Screenshot Issues screen"}
          >
            {showUiIssuesScreen ? "Close UI Issues" : "View UI Issues"}
          </button>
        </div>
